...
TRAJECTORY_BUILDER_2D.max_range = 3  -- the maximum scanning range of the lidar
TRAJECTORY_BUILDER_2D.missing_data_ray_length = 3 -- Restricted to maximum LiDAR scanning range  
